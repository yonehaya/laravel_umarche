        ...
        <div class="md:p-6 bg-white border-b border-gray-200">
          <section class="text-gray-600 body-font">
            <div class="container md:px-5 mx-auto">
              ...
              <div class="flex justify-end lg:w-2/3 w-full mx-auto mb-4">
                ...
                <table class="table-auto w-full text-left whitespace-no-wrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="md:px-4 py-3 text-lg text-gray-900"> {{$owner->created_at->diffForHumans()}}</td>
                      <td class="md:px-4 py-3 text-center">
                        <button onclick="location.href='{{ route('admin.owners.edit', ['owner' => $owner->id ]) }}'" class="text-white bg-blue-400 border-0 py-2 px-4 focus:outline-none hover:bg-blue-600 rounded">編集</button>
                      </td>
